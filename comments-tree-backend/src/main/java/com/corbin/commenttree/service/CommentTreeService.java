...
public interface CommentTreeService {
     ...
     * @return 成功与否
     */
    RestResult<CommentVO> submit(Long userId,String username, String content, Long parentId);
     ...
     * @return 留言或回复数据
     */
    PageRestResult<CommentVO> getComments(Long parentId, Integer deep, Integer size, Integer pageIndex);
}
